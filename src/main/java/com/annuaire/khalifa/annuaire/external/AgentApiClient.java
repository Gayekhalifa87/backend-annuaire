// Créer ce fichier : src/main/java/com/annuaire/khalifa/annuaire/external/AgentApiClient.java
...
public interface AgentApiClient {
    ...
    AgentPageResponse getAllAgents(@RequestParam(defaultValue = "0") int page,
